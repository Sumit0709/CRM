...
public class UserModel {
    ...
    public UserModel(Long id, String name, String email, String password, UserModel reportsTo, List<UserModel> subordinates, RoleModel role, List<ClientModel> clients, List<ReportModel> reports) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.password = password;
